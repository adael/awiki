...
class WikiPagesController extends WikiAppController
{
    ...
    public function view($alias = 'index')
    {
    ...
    public function print_view($alias)
    {
        $page = $this->WikiPage->findByAlias($alias);
        if (!$page) {
            $this->redirect('/');
    ...
    public function ajax_live_edit($alias = null)
    {
        $this->viewClass = 'Json';
    ...
    public function lock($alias = null)
    {
    ...
    public function unlock($alias = null)
    {
